angular.module('AngularPortfolio', ['AppSearch', 'AppAnimations', 'ui.state'])
  ...
  .controller('ListCtrl', ['$scope', '$rootScope', '$location', '$http', 'appSearch', '$stateParams', function($scope, $rootScope, $location, $http, appSearch, $stateParams) {
    var q, s = $stateParams.search;
